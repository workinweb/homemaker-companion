...
const dictionary: DictionaryType = {
    Home: {
        ...
        texts: {
            sectionName: "Home",
            agencyFor: "Evan Home Care is an agency for persons with disabilities that we are passionate about serving the community, making a difference through compassion and commitment to caring for and helping people with disabilities improve their quality of life.",
            ...
            agencyFor2: "is an agency for people with disabilities that provide home care company serving the community with love and passion. Our caregivers support you and your family so that you can elevate your quality of life and make life more enjoyable and independent." +
            ...
            serviceQuality: "Evan Home Care works hard to achieve excellence in services we provide. The quality of services for our recipients will always be our top priority. If you have any questions or need to get in touch with us, visit our contact page for more information."
        }
    },
    ...
    AboutUs: {
        ...
        texts: {
            ...
            whyChooseUsText: "The Evan Home Care team consists of passionate, compassionate, and good character people along with a positive work environment built on mutual respect and professionalism., that are our attractive characteristics, forming a great professional team to satisfy the needs of our clients with a high level of quality.",
    ...
    Employment: {
        ...
        texts: {
            ...
            readBefore: "or call the Evan Home Care office at 321-300-9077. Please, read the application before sign and submit.",
